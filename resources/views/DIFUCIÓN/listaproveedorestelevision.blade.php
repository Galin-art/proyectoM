...
@endsection
@section('content')
estamos con los chalanes de tv


<h1 class="text-2xl text-center mt-10">Lista de Provedores de Television</h1>

<div class="">
    <p></p>
    <a href="{{route('ruta.irFormularioAgregarTv')}}">
        <button
...
<table class="border-collapse w-full">
    ...
    <tbody>
    @forelse($DatosProvedoresTv as $lisTv)
        ...
        <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
            ...
            <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static">
                ...
                <div class="flex justify-start  space-x-4">
                    ...
                    <a href="{{route('ProvedortvDetalle',$lisTv)}}" >
                    ...
                    <a href="{{route('editarProvedoresTv',$lisTv)}}" >
                    ...
                    <a >
                        ...
                        <form method="POST" action="{{route('ProvedorTv.destroy',$lisTv)}}">
                            @csrf
                            @method('DELETE')
